...
async function main() {
  console.log("\n╔════════════════════════════════════════════════════╗");
  console.log("║   Budget AI Assistant – Demo Data Seed             ║");
  console.log("╚════════════════════════════════════════════════════╝");
  ...
  try {
    ...
    await seedAnomalyFlags(requests);
    await seedScenarios(users);
    await seedDecisionLog(users, requests);
    ...
    console.log("╚════════════════════════════════════════════════════╝");
    console.log("\n📋 DEMO LOGIN ACCOUNTS (password: Demo@1234)");
    console.log("─────────────────────────────────────────────────────");
    console.log("  admin@demo.edu        → Admin (full access)");
    console.log("  analyst@demo.edu      → Budget Analyst (review + approve)");
    console.log("  editor.it@demo.edu    → Dept Editor, IT Dept");
    console.log("  editor.acad@demo.edu  → Dept Editor, Academic Affairs");
    console.log("  editor.fac@demo.edu   → Dept Editor, Facilities");
    console.log("  editor.res@demo.edu   → Dept Editor, Research");
    console.log("  editor.hr@demo.edu    → Dept Editor, HR");
    console.log("  viewer@demo.edu       → Viewer (read-only)");
    console.log("  cabinet@demo.edu      → Cabinet (leadership view)");
    console.log("  board@demo.edu        → Board Summary (narrowest view)");
    console.log("\n📦 DATA SEEDED");
    console.log("─────────────────────────────────────────────────────");
    console.log("  8   Departments");
    console.log("  10  Users (all roles)");
    console.log("  13  Budget Requests (all statuses, FY26+FY27)");
    console.log("  3   Anomaly Flags");
    console.log("  5   Budget Scenarios (Best/Expected/Constrained/Custom + FY26)");
    console.log("  6   Decision Log entries");
